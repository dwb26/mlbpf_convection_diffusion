...
int main(void) {
	...
	// int N_ref = 1000;
	int N_bpf = 1000;
	int level0_meshes[N_MESHES] = { 80, 60, 40, 20, 10 };
	// int N1s[N_ALLOCS] = { 0, 10, 25, 50, 100, 200 };
	// int N1s[N_ALLOCS] = { 0, 5, 25, 50, 100, 200 };
	// int N1s[N_ALLOCS] = { 0, 5, 9, 17, 33, 65, 129, 256 };
	// int N1s[N_ALLOCS] = { 0, 5, 25, 50, 100, 200, 400 };
	int N1s[N_ALLOCS] = { 0, 5, 25, 50, 100, 250, 500, 750 };
	// int N1s[N_ALLOCS] = { 0, 50, 100, 250, 500, 1000, 1500 };
	// int level0_meshes[N_MESHES] = { 20, 10 };
	// int N1s[N_ALLOCS] = { 50 };
